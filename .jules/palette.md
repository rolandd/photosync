...
## 2026-02-18 - Dynamic Progress Bar Colors
**Learning:** Changing the progress bar color (e.g., Red on error) during long-running tasks provides immediate feedback about failure, reducing user anxiety and wait time.
**Action:** Use status-aware colors for progress indicators (Gauge), not just static colors.
