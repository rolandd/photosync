...
## 2026-02-19 - Unified Progress Feedback
**Learning:** Matching the progress bar color to the application status (success/error/warning) reinforces the system state without requiring the user to read text.
**Action:** Use dynamic colors for `Gauge` widgets that mirror the border or status indicators.
