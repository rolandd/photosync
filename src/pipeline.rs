...
fn file_walker(
    ...
    // Performance Optimization: Convert excludes to OsString once
    // This avoids string allocations and UTF-8 validation (`to_string_lossy()`) on every directory entry.
