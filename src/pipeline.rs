...
fn file_walker(
    ...
    // Optimization: Convert exclude_dirs to OsString outside the loop
    // to avoid calling to_string_lossy() and allocating/validating UTF-8
    // on every single directory entry visited.
