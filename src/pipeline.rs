...
fn file_walker(
    ...
    // Optimization: Pre-allocate OsStrings to avoid to_string_lossy() on every directory entry,
    // which causes unnecessary UTF-8 validation and memory allocations during traversal.
