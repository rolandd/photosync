...
fn file_walker(
    ...
    // Pre-allocate OsString comparisons to avoid string allocation and
    // UTF-8 validation overhead on every single file encountered.
    // This makes the file discovery phase measurably faster on large directories.
