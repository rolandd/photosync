...
fn file_walker(
    ...
    // Optimization: Pre-allocate OsString vectors outside the hot loop
    // to avoid string allocation and UTF-8 validation overhead from to_string_lossy
    // on every file encountered during traversal.
